...
def run_case(all_case, reportName="report"):
    ...
    runner = HTMLTestRunner_cn.HTMLTestRunner(fp,
                            title='报告的标题：这个是我的接口项目',  # 报告标题
                            description='报告如下：',  # 报告的描述
                            verbosity=2,#verbosity=2,  # 将注释在测试用例中展示
                            retry=None#retry=1  # 失败后，重跑1次（次数可随意更改）默认为空
                            )
...
if __name__ == "__main__":
    ...
    #邮箱配置
    sender = "252853297@qq.com"
    psw = "zzjityvnwufnbhbi" #qq需要授权码
    smtp_server = "smtp.qq.com"
    port = 465
    # receiver = "252853297@qq.com" #多个时候为list
    #多个收件人
    receiver =['461278214@qq.com','252853297@qq.com']
